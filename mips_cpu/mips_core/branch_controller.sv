...
module branch_controller (
	...
	// Feedback
	pc_ifc.in dec_pc,
	branch_result_ifc.in dec_branch_resolved
);
	...
	always_comb
	begin
		if_branch_prediction.recovery_target =
			(btb_hit & (if_branch_prediction.prediction == TAKEN))
	...
	if (i_decoded.valid)
		begin
			...
			case(i_decoded.alu_ctl)
				...
				default: o_branch_resolution.valid = 1'b1;
			endcase
		end
		else begin
